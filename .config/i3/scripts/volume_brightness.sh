...
function show_brightness_notif {
    ...
    get_brightness_icon
    dunstify -t 1000 -r 2593 -u normal "$brightness_icon $((($(blight get) * 100) /max_brightness))%" -h int:value:$brightness -h string:hlcolor:$bar_color
}
